...
socket.on("messageNotification", (socket) => {
  // en el socket vienen tres objetos: "data" normalizada desde el back, el "mensajesSchema" para desnormalizar y "dataSinNormalizar" para poder mostrar la lista, porque no me funciona la desnormalizacion
